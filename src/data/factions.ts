...
export const FACTIONS: FactionDef[] = [
  ...
  { id: 7, name: "黑帆书库", category: "SHADOW", image: assetUrl("images/factions/heifanshuku.jpg"), quote: "知识不问出处，只问谁能读懂。", intro: "像海盗一样掠夺和收集叙事知识，收藏大量禁书和秘密知识。", win: "累计从其他玩家处获得2张手牌或畸变物。" },
  ...
  { id: 11, name: "锈字修道院", category: "SEEKER", image: assetUrl("images/factions/xiuzixiudao.jpg"), quote: "锈迹是时间的批注，修道院是时间的编辑。", intro: "守护古老叙事，修复破损叙事遗迹和文本。", win: "累计恢复篇幅达到8段。" },
  ...
  // COURIER 传递
  { id: 20, name: "渡鸦邮局", category: "COURIER", image: assetUrl("images/factions/duyayouju.jpg"), quote: "渡鸦从不迷路，因为它们飞的路线不在地图上。", intro: "使用特殊训练的渡鸦作为信使，在叙事层面飞行。", win: "累计从牌堆摸牌数达到28张。" },
